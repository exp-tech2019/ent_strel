...
$SumAll=$CostAll+$SumPlusAll-$SumMinusAll;
$mpdf->WriteHTML("<h4>Всего: $SumAll</h4>");
...
");
    ...
    foreach ($arrNaryads as $n) {
        ...
        $mpdf->WriteHTML(
			...
			<td style='border:solid 0.5px gray; padding: 2px'>$NumInOrder</td>
