...
// JavaScript file-like object
    ...
    CopyProp:function () {
	    console.log($("#PropPrlTypeDoor").val()!="" & $("#PropPrlCopy_TypeDoor").val()!="" & $("#PropPrlTypeDoor").val()!=$("#PropPrlCopy_TypeDoor").val());
