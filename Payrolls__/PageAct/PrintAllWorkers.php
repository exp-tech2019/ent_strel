...
function AddRow($sheet, $RowPos, $FIO, $Dolgnost, $SumWith, $Cost, $Payment, $InPayment, $Nalog, $PaymentsWithNalog, $PaymentAll, $SumEnd){
    ...
    $sheet->setCellValue('C'.$RowPos, $SumWith);
    $sheet->setCellValue('D'.$RowPos, $Cost);
    $sheet->setCellValue('E'.$RowPos, $Payment);
    $sheet->setCellValue('F'.$RowPos, $InPayment);
    $sheet->setCellValue('G'.$RowPos, $Nalog);
    $sheet->setCellValue('H'.$RowPos, $PaymentsWithNalog);
    $sheet->setCellValue('I'.$RowPos, $PaymentAll);
    $sheet->setCellValue('J'.$RowPos, $SumEnd);
