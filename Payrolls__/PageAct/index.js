...
function CalcItog(){
    ...
    $("#WorkerTableFooter tr:eq(0) th[Type=SumWith]").text(SumWith);
    $("#WorkerTableFooter tr:eq(0) th[Type=SumCost]").text(SumCost);
    $("#WorkerTableFooter tr:eq(0) th[Type=SumPlus]").text(SumPlus);
    $("#WorkerTableFooter tr:eq(0) th[Type=SumPlusAll]").text(SumPlusAll);
    $("#WorkerTableFooter tr:eq(0) th[Type=SumPlusAllNalog]").text(SumPlusAllNalog);
    $("#WorkerTableFooter tr:eq(0) th[Type=SumMinus]").text(SumMinus);
    $("#WorkerTableFooter tr:eq(0) th[Type=BalanceNalog]").text(BalanceNalog);

    $("#MainAllPlusNalog").val(SumPlusAllNalog1);
    $("#MainAllMinus").val(SumMinus1);
}
