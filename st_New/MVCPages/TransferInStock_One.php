<script src="scripts/TransferInStock_One.js"></script>
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <button onclick="window.location.href='?MVCPage=TransferInStock_List'" class="btn btn-danger">Открыть ранние выдачи</button>
            <button onclick="Save()" class="btn btn-success">Вернуть</button>
        </div>
        <div class="box-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="LoginFIO" class="col-xs-1 control-label">Получил</label>
                    <div class="col-xs-2">
                ...
                <div class="form-group">
                    <label  for="WorkerFIO" class="col-xs-1 control-label">Вернул</label>
